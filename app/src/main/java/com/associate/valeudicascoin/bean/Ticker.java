...
public class Ticker {
    ...
    public Ticker(String jsonExchange) {
        ;
        try {
    ...
    public Ticker(PropertyDB name, PropertyDB color, PropertyDB url, PropertyDB url_book, PropertyDB fees_in_BRL, PropertyDB fees_in_BTC,
